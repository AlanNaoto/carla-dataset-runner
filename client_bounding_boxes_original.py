    ...
    def game_loop(self):
        ...
        try:
            ...
            while True:
                ...
                bounding_boxes_vehicles = ClientSideBoundingBoxes.get_bounding_boxes(vehicles_on_screen, self.camera)
                # bounding_boxes_walkers = ClientSideBoundingBoxes.get_bounding_boxes(walkers_on_screen, self.camera)
                ClientSideBoundingBoxes.draw_bounding_boxes(self.display, bounding_boxes_vehicles)
                # ClientSideBoundingBoxes.draw_bounding_boxes(self.display, bounding_boxes_walkers)
